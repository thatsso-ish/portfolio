...
export default function ContactSection() {
  return (
    <section className="w-full max-w-4xl mx-auto bg-white dark:bg-brand-dark rounded-xl sm:rounded-2xl shadow-lg px-2 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 mt-6 sm:mt-10 lg:mt-14 mb-6 sm:mb-8 lg:mb-10">
      <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-6 lg:mb-8 text-brand-blue text-center lg:text-left">
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
        ...
        <div className="flex-1 flex flex-col justify-between space-y-4 sm:space-y-6">
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-2 sm:mb-4">
            <a href="tel:+27790526257" className="bg-brand-blue/90 hover:bg-brand-blue text-white font-semibold px-3 sm:px-5 lg:px-6 py-2 sm:py-2 rounded-lg sm:rounded-xl shadow-md transition inline-block text-center text-xs sm:text-sm lg:text-base w-full">Hire me</a>
            <a href="tel:+27790526257" className="border border-brand-blue text-brand-blue font-semibold px-3 sm:px-5 lg:px-6 py-2 sm:py-2 rounded-lg sm:rounded-xl shadow-sm hover:bg-brand-blue hover:text-white transition inline-block text-center text-xs sm:text-sm lg:text-base w-full">Let's talk</a>
          </div>
        ...
        <div className="flex-1">
          <form action="https://formspree.io/f/mkgwgvyk" method="POST" className="space-y-2 sm:space-y-3 w-full">
            ...
            <button type="submit" className="w-full bg-brand-blue hover:bg-blue-700 text-white font-semibold py-2 sm:py-2 rounded-lg shadow transition text-xs sm:text-sm">Send</button>
          </form>
        </div>
      </div>
    </section>
